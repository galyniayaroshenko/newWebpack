...
/***/ function(module, exports, __webpack_require__) {
	...
	var _templateMainHbs = __webpack_require__(7);

	var _templateMainHbs2 = _interopRequireDefault(_templateMainHbs);

	console.log(_lodash2['default'].isEqual(1, 2));
	console.log('Smile');
	console.log('template', (0, _templateMainHbs2['default'])({ name: 'Smile' }));
